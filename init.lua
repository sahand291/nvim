...
-- window management
vim.keymap.set('n', '<leader>b%', '<C-w>v', { desc = 'Split window vertically' }) -- split window vertically
vim.keymap.set('n', '<leader>b"', '<C-w>s', { desc = 'Split window horizontally' }) -- split window horizontally
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      local v = '/home/sahand/.local/share/nvim/mason/packages/vue-language-server/node_modules/@vue/language-server'
      --   local vue_plugin = {
      --     name = '@vue/typescript-plugin',
      --     location = '/home/sahand/.local/share/nvim/mason/packages/vue-language-server/node_modules/@vue/language-server',
      --     languages = { 'vue' },
      ...
      vim.lsp.enable { 'vtsls', 'vts_ls' } -- If using `ts_ls` replace `vtsls` to `ts_ls`
